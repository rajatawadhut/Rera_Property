...
import com.rera.property.Avtivities.AddImgActivity;
import com.rera.property.Avtivities.CallBackForm;
import com.rera.property.Avtivities.DetailsPropertyShowActivity;
import com.rera.property.Avtivities.LatestActivity;
import com.rera.property.Avtivities.MyPropertyActivity;
import com.rera.property.Avtivities.ShortlistedActivity;
import com.rera.property.Avtivities.ShowSearchProperty;
import com.rera.property.Avtivities.ShowUSerList;
import com.rera.property.Avtivities.ViewMoreActivity;
import com.rera.property.Helper.DateConvert;
import com.rera.property.Helper.DeletePropertyHelper;
import com.rera.property.Helper.ShortlistedHelper;
...
public class LatestAdapter extends RecyclerView.Adapter<LatestAdapter.ShowData> {
    ...
    public ShowData onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view;
        if (viewType == 1) {
            view = LayoutInflater.from(parent.getContext()).inflate(R.layout.property12, parent, false);
        } else {
            view = LayoutInflater.from(parent.getContext()).inflate(R.layout.property12_reverse, parent, false);
        }
...
//        }
        ...
        if(dataSet.get(position).getReg_date() != null && dataSet.get(position).getReg_date() != ""){
            DateConvert dateConvert = new DateConvert(dataSet.get(position).getReg_date());
            date = dateConvert.getdateconvert();
        }
