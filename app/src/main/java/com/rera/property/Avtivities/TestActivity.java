...
import com.rera.property.Adapter.AdsViewPager;
import com.rera.property.Adapter.PgAdapter;
import com.rera.property.Adapter.RentAdapter;
import com.rera.property.Adapter.SellAdapter;
import com.rera.property.Adapter.ViewPagerAdapter;
import com.rera.property.AddPropertActivity.BasicDetails;
import com.rera.property.Helper.DataForCounter;
import com.rera.property.Helper.DateForMsgCounterNotification;
import com.rera.property.Models.AdsDataModel;
import com.rera.property.Models.PgDataModel;
import com.rera.property.Models.RentDataModel;
import com.rera.property.Models.SellDataModel;
import com.rera.property.R;
import com.rera.property.Utils.Endpoints;
import com.rera.property.Utils.ListingData;
import com.rera.property.Utils.SliderUtils;
...
//        toolbar.setTitle("Rera Property");
...
//        advertisement.setAdapter(adsAdapter);
        ...
        search.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intsl = new Intent(TestActivity.this, SearchProperty.class);
...
//                startActivity(new Intent(MainActivity.this, PaymentActivity.class));
        ...
        sellviewmore.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                        Intent intent = new Intent(TestActivity.this, ViewMoreActivity.class);
        ...
        btnbuyservice.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(TestActivity.this, Buyourservices.class));
            }
        });
        ...
        latestfooter.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent footorlatest = new Intent(TestActivity.this, LatestActivity.class);
        ...
        shortlisted.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(VolleySingleton.getInstance(getApplicationContext()).isLogin()){
                    Intent footorlatest = new Intent(TestActivity.this, ShortlistedActivity.class);
                    footorlatest.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
                    startActivity(footorlatest);
                }else{
                    Intent footorlatest = new Intent(TestActivity.this, LoginActivity.class);
                    footorlatest.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
                    startActivity(footorlatest);
                }
        ...
        addfooter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(VolleySingleton.getInstance(getApplicationContext()).isLogin()){
                    ...
                    startActivity(new Intent(TestActivity.this, BasicDetails.class));
                }else{
        ...
        post_pro.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intebuy = new Intent(TestActivity.this, SearchProperty.class);
        ...
        feelfree.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(TestActivity.this, ContactActivity.class));
            }
        });
        ...
        toggle = new ActionBarDrawerToggle(TestActivity.this,drawer,toolbar,R.string.open,R.string.close);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    ...
                    case R.id.testimonials:
                        Intent intel5 = new Intent(TestActivity.this, TestimonialsActivity.class);
                    ...
                    case R.id.addproperty:
                        ...
                        if(VolleySingleton.getInstance(getApplicationContext()).isLogin()){
                            Intent inte = new Intent(TestActivity.this, BasicDetails.class);
                            inte.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
                            startActivity(inte);
                        }else{
                            Intent inte = new Intent(TestActivity.this, LoginActivity.class);
                            inte.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
                            startActivity(inte);
                        }
                        break;
                    ...
                    case R.id.service:
                        Intent intemys = new Intent(TestActivity.this, Buyourservices.class);
                    ...
                    case R.id.setting:
                        Intent intel = new Intent(TestActivity.this, SettingActivity.class);
                    ...
                    case R.id.profile:
                        Intent intep = new Intent(TestActivity.this, ProfileActivity.class);
                    ...
                    case R.id.userlist:
                        Intent intepu = new Intent(TestActivity.this, OwnerBuilderDeveloperList.class);
                    ...
                    case R.id.shortlisted:
                        Intent intes = new Intent(TestActivity.this, ShortlistedActivity.class);
                    ...
                    case R.id.myproperty:
                        Intent intemy = new Intent(TestActivity.this, MyPropertyActivity.class);
                    ...
                    case R.id.lead:
                        Intent intsl = new Intent(TestActivity.this, SearchLead.class);
                    ...
                    case R.id.latest:
                        Intent intelp = new Intent(TestActivity.this, LatestActivity.class);
                    ...
                    case R.id.navabout:
                        Intent inta = new Intent(TestActivity.this, AboutActivity.class);
                    ...
                    case R.id.contact:
                        ...
                        if(VolleySingleton.getInstance(getApplicationContext()).isLogin()){
                            Intent intc = new Intent(TestActivity.this, ContactActivity.class);
                            intc.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
                            startActivity(intc);
                        }else{
                            Intent intc = new Intent(TestActivity.this, LoginActivity.class);
                            intc.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
                            startActivity(intc);
                        }
                    ...
                    case R.id.logout:
                        new AlertDialog.Builder(TestActivity.this).setIcon(android.R.drawable.ic_dialog_alert).setTitle("Logout")
                                .setMessage("Are you sure?")
                                .setPositiveButton("yes", new DialogInterface.OnClickListener() {
                                    @Override
                                    public void onClick(DialogInterface dialog, int which) {
                                        VolleySingleton.getInstance(getApplicationContext()).Logout();
                                        Intent intl = new Intent(TestActivity.this, LoginActivity.class);
                    ...
                    case R.id.login:
                        VolleySingleton.getInstance(getApplicationContext()).Logout();
                        Intent int2 = new Intent(TestActivity.this, LoginActivity.class);
                ...
                try {
                    ...
                    if(succes.equals("1")){
                        ...
                        for(int i=0; i<jsonArray.length();i++){
                            ...
                            AdsViewPager adsViewPager = new AdsViewPager(adsDataModels, TestActivity.this);
                ...
                try {
                    ...
                    if(succes.equals("1")){
                        ...
                        for(int i=0; i<jsonArray.length();i++){
                            ...
                            ViewPagerAdapter viewPagerAdapter = new ViewPagerAdapter(sliderImg, TestActivity.this);
...
//        requestQueue.add(stringRequest);
    ...
    public class MyTimertask extends TimerTask {
        ...
        ViewPagerAdapter mAdapter = new ViewPagerAdapter(sliderImg, TestActivity.this);
