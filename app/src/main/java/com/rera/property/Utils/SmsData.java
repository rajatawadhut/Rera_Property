package com.rera.property.Utils;
...
/*
    ...
    curl_setopt($ch, CURLOPT_POSTFIELDS, "username=9ninesquareproperty&password=99700151&source=NSQPRP&dmobile=".$mobileNumber.
            ...
            Welcome to Rera Property! Your OTP code is ".$otpCode.". Please DO NOT share this OTP with anyone. Contact us for any query at ".$url."");
            curl_setopt($ch, CURLOPT_RETURNTRANSFER,1);
    $data = curl_exec($ch);

    Welcome to Rera Property! Your OTP code is 5288. Please DO NOT share this OTP with anyone.
...
/*
    ...
    public String subject = "Otp Of Rera Property";
    public String message = "Welcome to Rera Property! Your OTP code is ";
...
*/
    ...
    String atthe = "@";
    String url = "www.9squareproperty.com/contact";
    public String Username = "9ninesqujfjfjfhjareproperty";
    public String Password = "997jfjfj00151";
    public String source = "NfjhjfjSQPRP";
    public String dltentityid = "150hjhfjfj1782580000035825";
    public String dltheaderid = "1505164559938666054";
    public String dlttempid = "1507164560030455513";
    public String subject = "Otp Of Rera Property";
    public String message = "Welcome to Rera Property! Your OTP code is ";
